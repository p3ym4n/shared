...
import (
	...
	v1 "github.com/p3ym4n/shared/log/v1"
...
func (_m *Logger) GetFormat() v1.Format {
	ret := _m.Called()

	var r0 v1.Format
	if rf, ok := ret.Get(0).(func() v1.Format); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(v1.Format)
	}
...
func (_m *Logger) GetLevel() v1.Level {
	ret := _m.Called()

	var r0 v1.Level
	if rf, ok := ret.Get(0).(func() v1.Level); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(v1.Level)
	}
...
func (_m *Logger) GetStd() *log.Logger {
	ret := _m.Called()
...
func (_m *Logger) Log(level v1.Level, msg string, args map[string]interface{}) {
	_m.Called(level, msg, args)
}

// LogMsg provides a mock function with given fields: level, msg
func (_m *Logger) LogMsg(level v1.Level, msg string) {
	_m.Called(level, msg)
}
